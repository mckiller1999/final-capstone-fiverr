  ...
  return (
    <div className="w-3/4 mx-auto mr-0">
      <Card>
        <CardContent>
          <div className="mx-auto text-center">
            <span className="font-bold text-blue-600 text-xl uppercase">Start working with me</span>
          </div>
          <hr className="my-3" />
          {text?.map((string: any) => {
            if (string === '') {
      ...
      <Card className="mt-5">
        ...
        <CardActions>
          <div className="mx-auto">
            <Button variant="outlined" onClick={() => { notify('error', 'Error') }}>Get a quote</Button>
          </div>
        </CardActions>
      </Card>
    </div>
