  ...
  return (
    <div className="footer">
      <div className="container">
        <div className="navigations grid grid-cols-1 md:grid-cols-5 md:gap-4">
          <div id="categories" className="w-full md:w-auto">
            <h3>Categories</h3>
            <ul>
              {footerMenu.categories.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
          <div id="about" className="w-full md:w-auto">
            <h3>About</h3>
            <ul>
              {footerMenu.about.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
          <div id="support" className="w-full md:w-auto">
            <h3>Support</h3>
            <ul>
              {footerMenu.support.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
          <div id="community" className="w-full md:w-auto">
            <h3>Community</h3>
            <ul>
              {footerMenu.community.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
          <div id="more-from-fiverr" className="w-full md:w-auto">
            <h3>More From Fiverr</h3>
            <ul>
              {footerMenu.moreFromFiverr.map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
