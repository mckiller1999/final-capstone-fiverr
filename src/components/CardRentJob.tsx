            ...
            <Card>
                ...
                <CardActions>
                    <div className="mx-auto">
                        <Button variant="contained" onClick={postRentJobApi}>Continue ${jobDetail.giaTien}</Button>
                    </div>
                </CardActions>
            </Card>
            <Card className="mt-5">
                <CardContent>
                    <h1 className="text-center text-gray-600">Do you have any special requirements ?</h1>
                </CardContent>
                <CardActions>
                    <div className="mx-auto">
